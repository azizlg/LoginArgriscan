...
import { Upload, Scan, MapPin, Coins, AlertCircle, Leaf, CreditCard, CheckCircle, XCircle, Activity, Clock, Brain, Stethoscope, Shield } from "lucide-react"
                  ...
                  <div className="space-y-8">
                    ...
                    {latestResult.treatment && (
                      <div className="animate-in slide-in-from-bottom-4 duration-1000 delay-1000">
                        <Card className="glass-subtle border-2 border-amber-200 bg-gradient-to-r from-amber-50 to-orange-50">
                          <CardContent className="p-6">
                            <div className="flex items-start gap-4">
                              <div className="p-3 bg-amber-500 rounded-full mt-1">
                      ...
                      <div className="animate-in slide-in-from-bottom-4 duration-1000 delay-1100 space-y-6">
                        <div className="text-center">
                          ...
                          <p className="text-muted-foreground text-lg">
                            Comprehensive agricultural insights powered by advanced AI
                          </p>
                        </div>
                        ...
                        <div className="grid grid-cols-1 lg:grid-cols-1 gap-6">
                          ...
                          {latestResult.analysis.aboutDisease && (
                            <Card className="glass-subtle border-2 border-purple-200 bg-gradient-to-br from-purple-50 via-blue-50 to-purple-50 shadow-lg">
                              <CardContent className="p-6">
                                <div className="flex items-start gap-4">
                                  <div className="p-3 bg-gradient-to-r from-purple-500 to-purple-600 rounded-full mt-1">
                          ...
                          {latestResult.analysis.treatmentRecommendations && (
                            <Card className="glass-subtle border-2 border-green-200 bg-gradient-to-br from-green-50 via-emerald-50 to-green-50 shadow-lg">
                              <CardContent className="p-6">
                                <div className="flex items-start gap-4">
                                  <div className="p-3 bg-gradient-to-r from-green-500 to-emerald-600 rounded-full mt-1">
                          ...
                          {latestResult.analysis.preventionTips && (
                            <Card className="glass-subtle border-2 border-amber-200 bg-gradient-to-br from-amber-50 via-orange-50 to-amber-50 shadow-lg">
                              <CardContent className="p-6">
                                <div className="flex items-start gap-4">
                                  <div className="p-3 bg-gradient-to-r from-amber-500 to-orange-600 rounded-full mt-1">
                        ...
                        <div className="text-center p-4 bg-gradient-to-r from-purple-100 to-blue-100 rounded-xl">
                          <div className="flex items-center justify-center gap-2 text-purple-700">
                            ...
                            <span className="text-sm font-medium">
                              Analysis Status: {latestResult.analysis.analysisStatus === 'completed' ? '✅ Complete' : '⚠️ Partial'}
                            </span>
                          </div>
                          <p className="text-xs text-purple-600 mt-1">
                            Powered by advanced agricultural AI • Generated in real-time
                          </p>
                        </div>
                      </div>
                    )}
